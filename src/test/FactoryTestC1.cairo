// Copy of the FactoryC1 contract. It's used to test the upgrade process
use starknet::ContractAddress;
use starknet::ClassHash;

#[starknet::interface]
trait IFactoryTestC1<TContractState> {
    // view functions
...
mod FactoryTestC1 {
    ...
    #[external(v0)]
    impl FactoryTestC1 of super::IFactoryTestC1<ContractState> {
        //
        // Getters
        //
        ...
        fn create_pair(ref self: ContractState, tokenA: ContractAddress, tokenB: ContractAddress) -> ContractAddress {
            ...
            let existing_pair = FactoryTestC1::get_pair(@self, tokenA, tokenB);
        ...
        fn set_fee_to(ref self: ContractState, new_fee_to: ContractAddress) {
            ...
            let fee_to_setter = FactoryTestC1::get_fee_to_setter(@self);
