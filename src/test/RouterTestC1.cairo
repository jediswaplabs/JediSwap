// Copy of the RouterC1 contract. It's used to test the upgrade process
...
//
#[starknet::interface]
trait IRouterTestC1<TContractState> {
    // view functions
...
mod RouterTestC1 {
    ...
    #[external(v0)]
    impl RouterTestC1 of super::IRouterTestC1<ContractState> {
        //
        // Getters
        //
