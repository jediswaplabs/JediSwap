...
func test_create2_deployed_pair{syscall_ptr: felt*, range_check_ptr}() {
    ...
    %{
        ...
        constructor_calldata = [ids.sorted_token_0_address, ids.sorted_token_1_address]
        ids.create2_pair_address = calculate_contract_address_from_hash(salt=salt, class_hash=ids.declared_pair_class_hash, deployer_address=ids.factory_address, constructor_calldata=constructor_calldata)
    %}
