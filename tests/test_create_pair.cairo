...
func test_create_pair_without_tokens{syscall_ptr: felt*, range_check_ptr}() {
    ...
    let (pair_address) = IFactory.create_pair(
        contract_address=factory_address, token0=token_0_address, token1=0
    );
...
func test_create_pair_same_tokens{syscall_ptr: felt*, range_check_ptr}() {
    ...
    let (pair_address) = IFactory.create_pair(
        contract_address=factory_address, token0=token_0_address, token1=token_0_address
    );
...
func test_create2_deployed_pair{syscall_ptr: felt*, range_check_ptr}() {
    tempvar declared_pair_proxy_class_hash;
    tempvar declared_pair_class_hash;
    tempvar factory_address;
    ...
    %{
        ids.declared_pair_proxy_class_hash = context.declared_pair_proxy_class_hash
        ids.declared_pair_class_hash = context.declared_pair_class_hash
        ids.factory_address = context.factory_address
        context.declared_router_class_hash = declare("contracts/Router.cairo").class_hash
        ids.router_address = deploy_contract("contracts/RouterProxy.cairo", [context.declared_router_class_hash, context.factory_address, context.deployer_address]).contract_address
        ids.token_0_address = context.token_0_address
        ids.token_1_address = context.token_1_address
    %}
    ...
    let (fee_to_setter_address) = IFactory.get_fee_to_setter(contract_address=factory_address);
    ...
    %{
        ...
        constructor_calldata = [ids.declared_pair_class_hash, ids.sorted_token_0_address, ids.sorted_token_1_address, ids.fee_to_setter_address]
        ids.create2_pair_address = calculate_contract_address_from_hash(salt=salt, class_hash=ids.declared_pair_proxy_class_hash, deployer_address=ids.factory_address, constructor_calldata=constructor_calldata)
    %}
