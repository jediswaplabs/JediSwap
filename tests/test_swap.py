...
@pytest.mark.asyncio
async def test_swap_exact_0_to_1(starknet, router, token_0, token_1, token_2, pair, other_pair, user_1, user_2, random_acc):
    user_2_signer, user_2_account = user_2
    random_signer, random_account = random_acc
    ...
    expected_amount_1 = (amount_token_0 * reserve_0_initial) / (amount_token_0 + reserve_1_initial)
...
@pytest.mark.asyncio
async def test_swap_0_to_exact_1(starknet, router, token_0, token_1, token_2, pair, other_pair, user_1, user_2, random_acc):
    user_2_signer, user_2_account = user_2
    random_signer, random_account = random_acc
    ...
    expected_amount_0 = (amount_token_1 * reserve_0_final) / reserve_1_initial
...
@pytest.mark.asyncio
async def test_swap_exact_0_to_2(starknet, router, token_0, token_1, token_2, pair, other_pair, user_1, user_2, random_acc):
    user_2_signer, user_2_account = user_2
    random_signer, random_account = random_acc
    ...
    expected_amount_1 = (amount_token_0 * reserve_0_0_initial) / (amount_token_0 + reserve_1_0_initial)
    print(f"Expected amount for token_1: {expected_amount_1}")
    expected_amount_2 = (expected_amount_1 * reserve_0_1_initial) / (expected_amount_1 + reserve_1_1_initial)
