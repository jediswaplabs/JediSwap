...
@external
func test_flash_swap_not_enough_liquidity{
    ...
    IPair.swap(
        contract_address=pair_address,
        amount0Out=Uint256(amount_token_0, 0),
        amount1Out=Uint256(0, 0),
        to=flash_swap_test_address,
        data_len=1,
        data=data,
    );
    %{ stop_prank() %}
...
@external
func test_flash_swap_not_enough_repayment{
    syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr
}() {
    alloc_locals;
    ...
    IERC20.mint(
        ...
        recipient=flash_swap_test_address,
        amount=Uint256(amount_to_mint_token_0, 0),
    );
    %{ stop_prank() %}
...
@external
func test_flash_swap_same_token_repayment{
    syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr
}() {
    alloc_locals;
...
@external
func test_flash_swap_other_token_repayment{
    syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr
}() {
    alloc_locals;
