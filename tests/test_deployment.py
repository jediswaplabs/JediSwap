...
@pytest.mark.asyncio
async def test_pair_in_registry(registry, token_0, token_1, pair, other_pair):
    ...
    assert execution_info.result.all_pairs == [pair.contract_address, other_pair.contract_address]
