# Mesh Finance AMM Starknet

Clone Uniswap V2 to Cairo
...
```
cd existing_repo
git remote add origin https://gitlab.com/meshfinance/mesh-finance-amm-starknet.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/-/experiment/new_project_readme_content:de92c17461650d500ebbab4fda218c6c?https://gitlab.com/meshfinance/mesh-finance-amm-starknet/-/settings/integrations)
